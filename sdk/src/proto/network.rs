...
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct BroadcastProofRequest {
    #[prost(string, tag = "1")]
    pub prood_id: ::prost::alloc::string::String,
    #[prost(uint32, tag = "2")]
    pub chain_id: u32,
    #[prost(string, tag = "3")]
...
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct BroadcastProofResponse {
    #[prost(string, tag = "1")]
    pub id: ::prost::alloc::string::String,
}
#[derive(serde::Serialize, serde::Deserialize)]
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct GetBroadcastStatusRequest {
    #[prost(string, tag = "1")]
    pub id: ::prost::alloc::string::String,
}
#[derive(serde::Serialize, serde::Deserialize)]
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct GetBroadcastStatusResponse {
...
pub trait NetworkService {
    ...
    async fn broadcast_proof(
        &self,
        ctx: twirp::Context,
        req: BroadcastProofRequest,
    ) -> Result<BroadcastProofResponse, twirp::TwirpErrorResponse>;
    async fn get_broadcast_status(
        &self,
        ctx: twirp::Context,
        req: GetBroadcastStatusRequest,
    ) -> Result<GetBroadcastStatusResponse, twirp::TwirpErrorResponse>;
}
    ...
    T: NetworkService + Send + Sync + 'static,
{
    twirp::details::TwirpRouterBuilder::new(api)
        ...
        .route(
            "/BroadcastProof",
            |api: std::sync::Arc<T>, ctx: twirp::Context, req: BroadcastProofRequest| async move {
                api.broadcast_proof(ctx, req).await
            },
        )
        .route(
            "/GetBroadcastStatus",
            |
                ...
                ctx: twirp::Context,
                req: GetBroadcastStatusRequest|
            async move { api.get_broadcast_status(ctx, req).await },
        )
        .build()
}
#[twirp::async_trait::async_trait]
pub trait NetworkServiceClient: Send + Sync + std::fmt::Debug {
    ...
    async fn broadcast_proof(
        &self,
        req: BroadcastProofRequest,
    ) -> Result<BroadcastProofResponse, twirp::ClientError>;
    async fn get_broadcast_status(
        &self,
        req: GetBroadcastStatusRequest,
    ) -> Result<GetBroadcastStatusResponse, twirp::ClientError>;
}
#[twirp::async_trait::async_trait]
impl NetworkServiceClient for twirp::client::Client {
    ...
    async fn broadcast_proof(
        ...
        let url = self
            .base_url
            .join("network.NetworkService/BroadcastProof")?;
        self.request(url, req).await
    }
    async fn get_broadcast_status(
        &self,
        ...
        let url = self
            .base_url
            .join("network.NetworkService/GetBroadcastStatus")?;
        self.request(url, req).await
    }
}
